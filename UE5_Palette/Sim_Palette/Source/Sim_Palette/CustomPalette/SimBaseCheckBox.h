...
#include "SimBaseCheckBox.generated.h"

class SSimCheckBox;
class USlateBrushAsset;
class USlateWidgetStyleAsset;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FSimOnCheckBoxComponentStateChanged, bool, bIsChecked );
 ...
 */
UCLASS()
class SIM_PALETTE_API USimBaseCheckBox : public UContentWidget
{
...
public:
	...
	FSimOnCheckBoxComponentStateChanged OnCheckStateChanged;
...
protected:
	TSharedPtr<SSimCheckBox> MyCheckbox;
